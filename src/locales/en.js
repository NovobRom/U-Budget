export default {
    ...
    confirm_remove_user_msg:
        'This user will lose access to the budget. Their transactions will remain.',
    confirm_leave_budget_msg:
        'You will no longer have access to this budget. Your transactions will remain.',
    ...
    recurring_empty:
        "No recurring transactions found. Mark a transaction as 'Recurring' when creating.",
    add_now: 'Add Now',
    ...
    exchange_rate_error:
        'Could not fetch current exchange rate. Using last known rate or manual input required.',
    ...
    load_more: 'Load more...',
    trends_title: 'Trends',
    time_filter_label: 'Select time period',
    recurring_btn: 'Recurring',
};
