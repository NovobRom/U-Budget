export default {
    ...
    confirm_remove_user_msg:
        'Цей користувач втратить доступ до бюджету. Його транзакції залишаться.',
    ...
    recurring_empty:
        "Немає регулярних транзакцій. Позначте транзакцію як 'Щомісячний платіж' при створенні.",
    ...
    exchange_rate_error:
        'Не вдалося отримати актуальний курс обміну. Використовується останній відомий курс або потрібен ручний ввід.',
    ...
    install_ios_step1:
        "1. Натисніть кнопку 'Поділитися' (квадрат зі стрілкою) внизу браузера Safari.",
    ...
    trends_title: 'Тренди',
    time_filter_label: 'Виберіть період',
    recurring_btn: 'Платежі',
};
