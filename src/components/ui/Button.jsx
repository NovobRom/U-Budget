...
const Button = ({ 
    ...
    const baseStyles = "font-bold py-3 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2";
    
    const variants = {
        primary: "bg-slate-900 dark:bg-blue-600 text-white hover:opacity-90 shadow-lg shadow-blue-500/20",
