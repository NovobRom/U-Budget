...
export default function CategoryGrid({
    categories, type, category, setCategory, getCategoryName, onAddCategory, t
}) {
    return (
        <div>
                    ...
                    .map(c => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className={`text-[10px] leading-tight text-center whitespace-normal break-normal w-full ${isSelected ? 'font-bold text-slate-900 dark:text-white' : 'text-slate-500'}`}>
                                    {getCategoryName(c)}
                                </span>
                            </button>
                        );
