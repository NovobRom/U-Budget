...
import CategoryRulesManager from './settings/CategoryRulesManager';
            ...
            <ConfirmModal
                ...
                message={
                    confirmModal.type === 'remove'
                        ? t.confirm_remove_user_msg
                        : t.confirm_leave_budget_msg
                }
                t={t}
            />
            ...
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[60] p-4 animate-in fade-in duration-200">
                <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-2xl p-6 shadow-xl max-h-[85vh] overflow-y-auto border border-slate-200 dark:border-slate-700 custom-scrollbar">
                    ...
                    <div className="space-y-6">
                        ...
                        <button
                            onClick={onLogout}
                            className="w-full py-4 mt-2 flex items-center justify-center gap-2 text-red-500 font-bold bg-red-50 dark:bg-red-900/20 rounded-xl hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors border border-red-100 dark:border-red-900/50"
                        >
